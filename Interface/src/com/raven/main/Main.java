...
public class Main extends javax.swing.JFrame {
    ...
    private void init() {
        ...
        menu.addEventMenu(new EventMenu() {
            ...
            public void selectedMenu(int index) {
                if (index == 0){
                   ...
                   mainBody.displayForm(new Matrix_Form());
                }else if (index == 1) {
                    try{
                    InternalChat ch = f.ch;
                    ...
                    mainBody.displayForm(new Number_Form());
                }
                else if (index == 3) {
                    try{
                    InternalChat ch = f.ch;
                    ...
                    mainBody.displayForm(new Filter_Form());
                }
                else if (index == 4) {
                    f = new FormChat();
                    mainBody.displayForm(f);
                }
        ...
        pro.setBackgroundImage("bg_1.jpg");
        pro.loadFromFile();
        pro.setColor(new Color(128,41,238));
